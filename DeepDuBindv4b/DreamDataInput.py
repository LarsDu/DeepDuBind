...
class DataCollectionHdf5:
    ...
    def _pull_batch(self,batch_size,epoch_tracker):
        ...
        for bi, pindex in enumerate(batch_indices):
            ...
            #cProfile.runctx('(dna_seq_data,dna_shape_data,dnase_data,chip_labels_data ) = DreamDataSaverHdf5.decode_1d_to_nd(self.data[pindex],self.shape_list)',locals(),globals())
    ...
    def pull_batch_train(self,batch_size):
        ...
        cProfile.runctx('batch =self._pull_batch(batch_size,self.epoch_tracker)',locals(),globals())
